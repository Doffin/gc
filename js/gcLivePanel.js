  ...
  constructor() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="panel">
        ...
        <tr><td><label data-i18n="livesensor.tid">Tid</label></td> <td><span id="tid">--</span></td><td><span data-i18n="livesensor.tidUnit">--</span></td></tr>
        <tr><td><label data-i18n="livesensor.last">Last</label></td> <td><span id="last">--</span></td><td><span data-i18n="livesensor.lastUnit">--</span></td></tr>
        <tr><td><label data-i18n="livesensor.setning">Setning</label></td> <td><span id="setning">--</span></td><td><span data-i18n="livesensor.setningUnit">--</span></td></tr>
        </table>
        </div>
      </div>
    `;
